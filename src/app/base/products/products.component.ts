...
import { ListService } from '../../shared/ui/list/list.service';
...
export class ProductsComponent implements OnInit {
  ...
  @Output() deleteClicked: EventEmitter<Product[]> = new EventEmitter();
  ...
  public selectItem({ checked }, item: Product&{id}) {
    if (checked) {
